...
<body>
	...
	<c:if test="${not empty cart.items}">
		...
		<h3>
			<font color="brown">お客様情報を入力してください。</font>
		</h3>
		...
		<form action="/shopping/OrderServlet?action=confirm" method="post">
			...
			<br> <input checked type="radio" name="pay" value="cash">代金引き換え
			<input type="radio" name="pay" value="card">クレジットカード決済 <input
				type="radio" name="pay" value="convini">コンビニ決済 <br> <br>
