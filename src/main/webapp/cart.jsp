...
<body style="background-color: #E3D7A3;">
	...
	<h3>
		<p style="color: brown">現在のカートの中身</p>
	</h3>

	<c:if test="${empty cart.items}">
		<h4>現在、カートは空です。</h4>
		<img
			src="https://3.bp.blogspot.com/-P6ZK7_CU1Is/UmuA4EO_8nI/AAAAAAAAZhc/4XWFy6_YTMA/s800/shopping_cart.png"
	...
	<c:if test="${not empty cart.items}">
		...
		<img
			src="https://2.bp.blogspot.com/-d2B4qMNWJQ4/Ur1HmKS3oiI/AAAAAAAAcjM/yk8Xg3FJh04/s800/shopping_cart_woman.png"
			width="200px" height="200px">
	</c:if>
